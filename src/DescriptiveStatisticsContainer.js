	...
	render(){
		...
		return (
			<Card className="descriptive_statistics_card">
				...
				<DescriptiveStatisticsLoader descrStatConfigs={this.state.descrStatConfigs} participantId={this.props.participantId} handleDeleteTile={this.handleDeleteTile.bind(this)}/>
